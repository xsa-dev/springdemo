...
<body>
	<div align="center">
		...
		<hr />
		<h3>Please register yourself as your Organizations
			Respresentative.</h3>
			...
			<table>
				...
				<tr>
					...
					<td><form:input path="verifyEmail"
							placeholder="Confirm Email Address" cssClass="cinput" /></td>
				...
				<tr>
					...
					<td class="cb"><form:errors path="verifyPassword"  /> <spring:hasBindErrors
							name="orgrep">
							<c:forEach items="${errors.globalErrors}" var="globalError">
				...
				<tr>
					...
					<td><form:password path="verifyPassword"
							placeholder="Confirm Password Address" cssClass="cinput" /></td>
