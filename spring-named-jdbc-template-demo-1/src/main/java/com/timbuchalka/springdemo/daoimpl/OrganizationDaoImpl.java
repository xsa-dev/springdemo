...
//		Object[] args = new Object[] { id };
	...
	public List<Organization> getAllOrganizations() {
		...
		List<Organization> orgList = namedParamJdbcTemplate.query(sqlQuerry, new OrganizationRowMapper());
		return orgList;
	}

	public boolean delete(Organization org) {
		SqlParameterSource beanParams = new BeanPropertySqlParameterSource(org);
		String sqlQuerry = "DELETE FROM organization WHERE id = :id";
		return namedParamJdbcTemplate.update(sqlQuerry, beanParams) == 1;
